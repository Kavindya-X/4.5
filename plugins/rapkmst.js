...
if (Config.WORKTYPE == 'private') {
     ...
     RAVANA.useCmd({ pattern: 'rapkmod ?(.*)', fromMe: true,desc: Apk}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'rawamo', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'ravm', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'ravv', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'rapa', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'rapy', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'rads', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'ragve', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'rape', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
     ...
     RAVANA.useCmd({ pattern: 'rapkmod ?(.*)', fromMe: false,desc: Apk}, (async (message, match) => {

        await message.sendMessage("*╔═▣═══❖⦁⦁⦁💢⦁⦁⦁❖═══▣═╗*\n║  *🤴RAVANA MOD STORE🤴*  ║\n*╚═══❖═══▣ ╩ ▣════❖═══╝*\n\n*මෙමෙ ඇප් සියල්ල බොට් හරහා ලබාගත හැක.*\n\n*|🔰RAVANA WA MOD v1 - .rawamo*\n\n*|🔰Video Marker v1.61 premium - .ravm*\n\n*|🔰VivaVideo 8.11.3 p - .ravv*\n\n*|🔰Piscart gold full v.17.3.1  - .rapa*\n\n*|🔰PLAYit v2.5.8.14 vip - .rapy*\n\n*|🔰Dual Space Lite v3.1.1 vip - .rads*\n\n*|🔰Glitch video efct pro- .ragve*\n\n*|🔰Photo editer v6.9 pro - .rape*\n\n\n*තවත් ඇප් ඉදිරියේදී එකතුවේ..*\n________________________");    

    }));

RAVANA.useCmd({ pattern: 'rawamo', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'ravm', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'ravv', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'rapa', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'rapy', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'rads', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'ragve', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: 'rape', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
